        ...
        <div id="view-wrapper">
            <div class="view-photo-gallery">
             ...
             <div id="view-wrapper-second">
                 ...
                 <div>
                     <?php 
                        ...
                        echo '<form action="landviewphp.php?cid='.$cid.'&pid='.$pid.'&fav='.$fav.'" method="post" >';
                         if($fav==0)
                            {
                               echo '<button type="submit" name="add">Add to Favorites</button>';
                            }
                         else if($fav==1)
                            {
             ...
             <div>
                ...
                echo '<form method="post" action="dashregister.php?cid='.$cid.'&pid='.$pid.'"><button>EDIT</button></form>';
                }
                 else
                     echo '<form action="sendmailf.php?cid='.$cid.'&pid='.$pid.'" method="post">
                     <button type="submit" name="send">I"m interested</button>
                     </form>';
                 ?>
